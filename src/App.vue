...
<style>
  .penalties {
    background-image: url('./assets/RefereePenaltysignals.png');
  ...
  .icing {
    background-position: -940px -630px;
  }
  ...
  .tripping {
    background-position: -110px -940px;
  }
  ...
  .misconduct {
    background-position: -580px -940px;
  }

  .spearing {
    background-position: -810px -940px;
  }
